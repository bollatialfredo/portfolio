...
const translations = {
  en: {
    ...
    'projects.sheepie.title': 'Sheepie - Familia Green WhatsApp Chatbot',
    'projects.sheepie.description': 'A WhatsApp chatbot to sell ice cream, built with Node.js and a Laravel Filament admin backoffice.',
    'projects.sheepie.backend': 'Chatbot Backend',
    'projects.sheepie.backend.item1': 'Node.js chatbot engine',
    'projects.sheepie.backend.item2': 'WhatsApp integration',
    'projects.sheepie.backend.item3': 'Order and checkout flows',
    'projects.sheepie.backend.item4': 'Inventory and pricing logic',
    'projects.sheepie.admin': 'Admin Backoffice',
    'projects.sheepie.admin.item1': 'Laravel + Filament',
    'projects.sheepie.admin.item2': 'Product and catalog management',
    'projects.sheepie.admin.item3': 'Orders dashboard',
    'projects.sheepie.admin.item4': 'Promotions and coupons',
    'projects.sheepie.architecture': 'Project Architecture',
  ...
  es: {
    ...
    'projects.sheepie.title': 'Sheepie - Chatbot de WhatsApp para Familia Green',
    'projects.sheepie.description': 'Un chatbot de WhatsApp para vender helado, construido con Node.js y un backoffice de administración en Laravel Filament.',
    'projects.sheepie.backend': 'Backend del Chatbot',
    'projects.sheepie.backend.item1': 'Motor de chatbot en Node.js',
    'projects.sheepie.backend.item2': 'Integración con WhatsApp',
    'projects.sheepie.backend.item3': 'Flujos de pedido y checkout',
    'projects.sheepie.backend.item4': 'Lógica de inventario y precios',
    'projects.sheepie.admin': 'Backoffice de Administración',
    'projects.sheepie.admin.item1': 'Laravel + Filament',
    'projects.sheepie.admin.item2': 'Gestión de productos y catálogos',
    'projects.sheepie.admin.item3': 'Panel de órdenes',
    'projects.sheepie.admin.item4': 'Promociones y cupones',
    'projects.sheepie.architecture': 'Arquitectura del Proyecto',
